;;; soft-era-theme.el --- Emacs port of the Soft Era theme. -*- lexical-binding: t; -*-
;;
...
;; Version: 0.0
;; Keywords: light theme faces cute
;; Homepage: https://github.com/soft-aesthetic/soft-era
...
;;; Commentary:
;;
;; This is a port of the Soft Era theme by <author>.
;;
;; # Installation
;;
;; ## Manual
;; Download `soft-era-theme.el` to the directory `~/.emacs.d/themes/`.
...
(let (
  ...
  (custom-theme-set-faces
   ...
   ;; Web-mode
   `(web-mode-html-tag-face         ((t  (:foreground  ,venus-600))))
   ...
   `(web-mode-current-column-highlight-face  ((t  (:background  ,uranus-500))))
